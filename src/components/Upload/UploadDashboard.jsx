...
const UploadDashboard = ({
  ...
  function getPixelRectsFromClickOrSelection({
    range,
    singleRect,
    wrapperRect,
  }) {
  ...
  useEffect(() => {
    ...
    const observer = new ResizeObserver((entries) => {
      if (entries[0]) {
        // Subtracting 40 to account for the p-4 (16px) padding and scrollbar space
                    ...
                    return (
                      ...
                      >
                        <Page
                          ...
                          // scale={1} <-- REMOVE THIS
                          width={containerWidth || undefined} // <-- ADD THIS
